...
SOURCES = main.c state.c level.c gui.c io.c mzapo_phys.c mzapo_parlcd.c
TARGET_EXE = bricksbreaker
ifeq ($(TARGET_IP),)
...
copy-executable: $(TARGET_EXE)
	...
	ssh $(SSH_OPTIONS) $(TARGET_USER)@$(TARGET_IP) mkdir -p $(TARGET_DIR) $(TARGET_DIR)/$(RESOURCES)
